...
class es_cls_common {
	public static function es_disp_status($value) {
		...
		switch ($value) {
			...
			case "Viewed":
				...
				break;
			case "Nodata":
				$returnstring = __( '<span style="color:#999900;">No Data</span>', 'email-subscribers' );
				break;
			case "Disable":
	...
	public static function es_sent_report_plain() {
		$report = "";
		$report .= "Hi Admin,\n\n";
		$report .= "Email has been sent successfully to {{COUNT}} email(s). Please see the details below:\n\n";
	...
	public static function es_sent_report_html() {
		...
		$report .= "Email has been sent successfully to {{COUNT}} email(s). Please see the details below:<br/><br/>";
